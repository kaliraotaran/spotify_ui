...
const List songs = [
  {
    ...
    "date": "about 19 hr",
    "color": Color.fromARGB(255, 62, 41, 127),
  ...
  },
  {
    ...
    "date": "about 11 hr",
    "color": Color.fromARGB(255, 98, 128, 136),
    "song_url": "songs/1.mp3",
    "songs": [
      {"title": "Imagination", "duration": "1:21"},
      {"title": "Home_", "duration": "2:17"},
  ...
  },
  {
    ...
    "title": "Rap Caviar",
    "description": "New Industry Leading Raps and Beats.",
    "song_count": "50 songs",
    "date": "about 17 hr",
    "color": Color.fromARGB(255, 144, 100, 31),
    "song_url": "songs/1.mp3",
    "songs": [
      {"title": "fukumean", "duration": "2:01"},
      {"title": "Aye", "duration": "2:54"},
      {"title": "From the Hood", "duration": "2:22"},
      {"title": "Search and Rescue", "duration": "3:03"},
      {"title": "Wit Da Racks", "duration": "2:31"},
      {"title": "I'm Geekin", "duration": "4:09"},
      {"title": "Bluffin", "duration": "2:40"},
    ]
  },
  {
